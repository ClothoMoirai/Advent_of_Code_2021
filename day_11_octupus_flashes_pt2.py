...
def process_octopus(octopus_input: list) -> dict:
    octodict = {'sync': 0, 'grid': defaultdict(defaultvalue)}
    counter = 0
...
def increment_grid(octodict: dict, cycle: int) -> dict:
